...
export var Step = function (_a) {
    var label = _a.label, completed = _a.completed, index = _a.index;
    ...
    return (React.createElement("div", { className: styles.stepWrapper },
        React.createElement("div", { className: stepClasses },
            React.createElement("div", null, !completed ? index + 1 : React.createElement(CheckedIcon, null))),
...
export var Stepper = function (_a) {
    var activeStep = _a.activeStep, props = __rest(_a, ["activeStep"]);
    return (React.createElement("div", { className: styles.stepperWrapper },
        React.createElement(StepperContext.Provider, { value: { activeStep: activeStep } }, props.children)));
};
