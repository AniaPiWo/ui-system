...
jest.mock("../../assets/icons/PlusIcon", function () { return function () { return (React.createElement("svg", { "data-testid": "plus-icon" })); }; });
jest.mock("../../assets/icons/LoadingIcon", function () { return function () { return (React.createElement("svg", { "data-testid": "loading-icon" })); }; });
describe("Button component", function () {
    it("should render Button component properly", function () {
        var getByText = render(React.createElement(Button, { onClick: function () { } }, "Click me")).getByText;
    ...
    it("should show SVG spinner when button is in loading state", function () {
        render(React.createElement(Button, { onClick: function () { }, isLoading: true, icon: true }, "Loading"));
    ...
    it("should render PlusIcon when button is not in loading state and icon is true", function () {
        render(React.createElement(Button, { onClick: function () { }, icon: true }, "Click me"));
    ...
    it("should have correct classes applied based on props", function () {
        var rerender = render(React.createElement(Button, { onClick: function () { }, variant: "primary" }, "Primary")).rerender;
        var primaryButton = screen.getByRole("button", { name: /primary/i });
        expect(primaryButton).toHaveClass("template primary");
        rerender(React.createElement(Button, { onClick: function () { }, variant: "secondary" }, "Secondary"));
        var secondaryButton = screen.getByRole("button", { name: /secondary/i });
        expect(secondaryButton).toHaveClass("template secondary");
        rerender(React.createElement(Button, { onClick: function () { }, variant: "primary", disabled: true }, "Disabled"));
