...
describe("TextField Component", function () {
    var setup = function (props) {
        ...
        var utils = render(React.createElement(TextField, __assign({}, defaultProps, props)));
        var input = utils.getByPlaceholderText(defaultProps.placeholder);
        return __assign(__assign({}, utils), { input: input, defaultProps: defaultProps });
    };
    it("should call onChange handler when typing into it", function () {
        var handleChange = jest.fn(function (event) { return event.target.value; });
        var _a = setup({
            onChange: handleChange,
            value: ""
        }), input = _a.input, rerender = _a.rerender, defaultProps = _a.defaultProps;
        fireEvent.change(input, { target: { value: "new value" } });
        rerender(React.createElement(TextField, __assign({}, defaultProps, { value: "new value", onChange: handleChange })));
